//////////////////////////////////////////////////////////
// This class has been cloned from freyaDiscriminator.h
//////////////////////////////////////////////////////////
...
Discriminator::Discriminator(TTree *tree) : fChain(0) 
{
  Init(tree);
}
...
Int_t Discriminator::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t Discriminator::LoadTree(Long64_t entry)
{
...
void Discriminator::Init(TTree *tree)
{
...
void Discriminator::Show(Long64_t entry)
{
